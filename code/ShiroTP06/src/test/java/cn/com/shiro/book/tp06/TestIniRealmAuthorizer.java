...
public class TestIniRealmAuthorizer {
	...
	@Test
	public void myTestRole(){
		UsernamePasswordToken token = new UsernamePasswordToken("zhangsan","123456");
		this.currUser.login(token);
		
		this.currUser.checkRole("role1");
		System.out.println(this.currUser.getPrincipal() + "拥有role1");
		
		if(this.currUser.isPermitted("user:view")){
			System.out.println(this.currUser.getPrincipal() + "可以 user:update");
		}else{
			System.out.println(this.currUser.getPrincipal() + "不能 user:update");
		}
	}
