...
public class TestJdbcRealmAuthorizer {
	...
	public void test1(){
		...
		this.currUser.login(token);
		this.currUser.checkRole("role2");
		System.out.println("admin");
		this.currUser.checkPermission("+17+3");
		System.out.println(this.currUser.getPrincipal() + "可以  order:view");
	}
