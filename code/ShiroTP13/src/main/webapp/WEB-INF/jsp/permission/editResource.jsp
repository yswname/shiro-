...
<div class="container-fluid">
  ...
  <div class="row " style="margin-top:55px;">
     ...
     <ol class="row breadcrumb">
        ...
        <li><a href="#"><!-- InstanceBeginEditable name="EditRegion5" -->修改资源<!-- InstanceEndEditable --></a></li>
     </ol>
		 ...
		 $(document).ready(function(e) {
            ...
            "<div class='row resourceItemrow'>"+
             "<div class='row'>"+
               ...
               "</div>"+
             "</div><input type='hidden' name='itmIds' value='-1'/>"+
             "<div class='row'>"+
...
"             </div>"+
     ...
     <div class="row navbar">
       ...
       <button class=" navbar-btn btn-primary">修改资源</button>
     ...
     <div class="row">
       ...
       <div class="row form-group">
         <label class="control-label text-right col-sm-2">所属模块</label>
         <div class="col-sm-8">
           <select name="modul" id="modul" class="form-control">
               <option value="1">题库管理</option>
               <option value="1">试卷管理</option>
       ...
       <div class="row form-group">
         ...
         <div class="col-sm-8">
           <input type="text" name="resource.rscName" id="resourceName" value="${resource.rscName }" class="form-control "/>
         </div>
       </div>
       <div class="row form-group">
         <label class="control-label text-right col-sm-2">资源说明</label>
         <div class="col-sm-8">
           <textArea  name="resource.rscRemark" id="resourceRemark" class="form-control ">${resource.rscRemark }</textArea>
         </div>
       </div>
       <input type="hidden" name="resource.rscId" id="resourceId" value="${resource.rscId }"/>
       ...
       <div class="row form-group" >
          ...
          <c:forEach items="${resource.shrResourceItems }" var="resItem" varStatus="status">
            <div class="row resourceItemrow">
             <div class="row">
               <label class="control-label col-sm-2 text-right">资源项名称</label>
               <div class="col-sm-6">
             ...
             <input type="hidden" name="itmIds" id="resourceItemId" value="${resItem.itmId }"/>
             <div class="row">
               <label class="control-label col-sm-2 text-right">资源项类型</label>
               <div class="col-sm-6">
                  <select id="resItem${status.index}" name="itmTypes" class="form-control">
                     <option value="1">新增资源</option>
                     <option value="2">修改资源</option>
                     <option value="4">删除资源</option>
                     <option value="8">查询资源</option>
                  ...
                  <script type="text/javascript">
                     $("#resItem${status.index}").val(${resItem.itmType});
                  </script>
               </div>
               <div class="col-sm-1">
                  <img src="images/icos/delete.png" onClick="toRemove(this)"/>
             ...
             <div class="row">
               <label class="control-label col-sm-2 text-right">资源项URL</label>
               <div class="col-sm-6">
                  <input type="text" name="itmUrls" id="resourceItemURL" value="${resItem.itmUrl }" class="form-control"/>
               </div>
             </div>
             <div class="row">
               <label class="control-label col-sm-2 text-right">资源项描述</label>
               <div class="col-sm-6">
                  <textArea name="itmRemarks" id="resourceItemRemark"  class="form-control">${resItem.itmRemark }</textArea>
               </div>
             </div>
            </div>
            <br/>
